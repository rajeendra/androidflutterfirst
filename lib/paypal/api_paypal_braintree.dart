...
class APIPayPalBraintree extends StatefulWidget {
  @override
  _APIPayPalBraintreeState createState() => _APIPayPalBraintreeState();
}

class _APIPayPalBraintreeState extends State<APIPayPalBraintree> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        util.buildHeader('PayPal payment'),
        Center(
          child: Column(
